    ...
    return (
        <SectionWrapper id="tools">
            <div ref={containerRef}>
                <h2 className="text-5xl md:text-7xl font-heading font-extrabold text-white mb-2 uppercase">PREMIUM</h2>
                <h2 className="text-5xl md:text-7xl font-heading font-extrabold text-zinc-500 mb-8 md:mb-12 uppercase">TOOLS</h2>
